...
export default function TabsRootLayout({
    ...
    return (
        <main className="flex max-h-screen flex-col">
            <div className="bg-gray-100 flex justify-between w-full px-6 items-center fixed top-0 z-20 h-16">
                <Link href="/">
                    index
                </Link>
                <Link href="/logout">
            ...
            {children}
            <div className="fixed bottom-0 p-5 px-6 flex items-center justify-between bg-gray-900 shadow-3xl text-gray-400 rounded-2xl cursor-pointer w-full">
